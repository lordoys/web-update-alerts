export default [
    ...
    },
    {
        ...
        selector: '.clearfix .Box .Box-body .Link--primary',
        content: 'v1.8.0 - Bifröst'
    },
    {
        name: 'iQuery github',
        url: 'https://github.com/jquery/jquery/releases',
        selector: '.clearfix .Box .Box-body .Link--primary',
        content: 'jQuery 4.0.0 BETA!'
    },
    {
        name: 'Backbone github',
        url: 'https://github.com/jashkenas/backbone/tags',
        selector: '.clearfix .Box .Box-body .Link--primary',
        content: '1.6.0'
    },
    {
    ...
    },
    {
        ...
        url: 'https://docs.meteor.com/changelog',
        selector: '.document-formatting h2',
        content: 'v2.15.0, 2024-02-05'
    },
    {
        name: 'Polymer github',
        url: 'https://github.com/Polymer/polymer/releases',
        selector: '.clearfix .Box .Box-body .Link--primary',
        content: 'v3.4.1'
    },
    {
        name: 'Aurelia github',
        url: 'https://github.com/aurelia/framework/releases',
        selector: '.clearfix .Box .Box-body .Link--primary',
        content: '1.4.1'
    },
    {
    ...
    },
    {
        ...
        selector: '#page-doc h2',
        content: '4.18.1 - Release date: 2022-04-29'
    },
    {
        name: 'Express github',
